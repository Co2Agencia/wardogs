"""
Django settings for wardogs project.
...
REST_FRAMEWORK = {
    ...
    'DEFAULT_PAGINATION_CLASS': 'api.utils.PaginationClass',
    'PAGE_SIZE': 6,
...
WSGI_APPLICATION = 'wardogs.wsgi.application'
